...
const FavoritesList: FC<Props> = ({ onClose }) => {
  ...
  return (
    <div
      className='fixed top-16 right-40 mt-1 bg-secondary text-light rounded-lg shadow-lg z-50 overflow-y-auto max-h-96 w-80 transition-transform transform'
      ref={resultsRef}
