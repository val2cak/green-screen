...
const Cover = () => {
  ...
  return (
    <div className='absolute top-0 left-0 bg-hero bg-cover w-full sm:h-[21.5rem] h-[750px] z-1 2xl:bg-center'>
      <div className='w-full h-full sm:px-8 px-40 2xl:px-56 pb-36 flex flex-col gap-4 items-center justify-end bg-gradient-to-t from-primary to-transparent to-20%'>
